...
Создан DOM-элемент следующей структуры.  Использована шаблонизация.
...
Создан DOM-элемент следующей структуры.
...
При нажатии на кнопку `Load more` догружается следующая порция
изображений и рендериться вместе с предыдущими.

Страница автоматически плавно проскроливается после рендера изображений,
чтобы перевести пользователя на следующие загруженные изображения. Используется
метод
...
- Добавлен плагин нотификаций, 
  [pnotify](https://github.com/sciactive/pnotify), и показывается нотификация на
